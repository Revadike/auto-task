...
// @updateURL    https://hclonely.github.io/auto-task/auto-task-test.user.js
...
<el-badge is-dot class="item" :hidden="hidden" v-if="updateBtn">
...
`);
        ...
        fuc.echoLog({
            type: 'custom',
            text: `<li><font class="warning">当前版本为测试版，用于测试Gamehag人机验证BUG,测试结束后请换回正式版！</font></li>`
        });
